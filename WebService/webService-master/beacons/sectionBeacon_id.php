<?php
	...
	if($status=='sectionBeacon_id')
	{

		// Abrimos conexion
		$enlace = conectar();

		// Regresa informacion de la secciones divididas por beacon_id
		$sql = 'SELECT id, beacon_id, floor FROM public.sections WHERE beacon_id = $1;';
